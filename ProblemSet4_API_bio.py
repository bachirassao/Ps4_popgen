...
# 1.fetching information about species from the GBIF AP
...
# 2. fetching occurrence data for a species, allowing me to find where certain species have been observed.
import requests
import pandas as pd
...
# 3. fetching information about the countries available in the GBIF API. This can be useful for querying occurrences or species data by country.
import requests
import pandas as pd
...
# 4. using the Maps API to generate a map for species occurrences. This will return a map image URL that can be displayed.
import requests
...
# literature API use to search for peer-reviewed articles that cite GBIF data. Here, an example of fetching literature that mentions GBIF.
import requests
import pandas as pd
